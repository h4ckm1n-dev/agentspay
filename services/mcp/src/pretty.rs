...
///
/// Resolution order, highest precedence first: `NO_COLOR` disables color,
/// `FORCE_COLOR` enables it for Docker/CI/piped renderers, and otherwise
/// `std::io::stderr().is_terminal()` decides.
